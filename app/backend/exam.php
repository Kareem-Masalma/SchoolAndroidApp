...
try {
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'GET') {
        if (isset($_GET['mode']) && $_GET['mode'] === 'student_exams' && isset($_GET['student_id'])) {
        ...
        echo json_encode(["success" => false, "message" => "Invalid GET request or missing parameters"]);
        exit;
    }
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        if (empty($input['students'])) {
            echo json_encode(["success" => false, "message" => "Missing student results"]);
            exit;
        }
        ...
        echo json_encode(["success" => true, "message" => "Exam and student marks submitted"]);
        exit;
    }
